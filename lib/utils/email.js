...
const fromEmail = 'bebejanedev@gmail.com';
const fromName = 'Bebe Jane'
const allowed = ['bebejanedev@gmail.com', 'mattias@konst-teknik.se']
...
const send = async (options, template) => {
  ...
  const message = {
    ...
    to: allowed.includes(options.to) ? options.to : `bebejanedev@gmail.com`, //options.to,
